...
public class TabSeries extends Fragment implements TimelineInterface {
    ...
    public static TabSeries newInstance() {
        return new TabSeries();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frame_series, container, false);
    ...
    private void getData() {
        ...
        if(category == 1) {
            timelinePresenter.getPopularSeries(baseUrl, apiKey, language, page);
        } else if(category == 2) {
            timelinePresenter.getTopRatedSeries(baseUrl, apiKey, language, page);
        }
    }
    ...
    private void setupRecycler(List<Item> items) {
        ...
        ItemRecyclerAdapter adapter = new ItemRecyclerAdapter(context, items, baseUrlImage, false);
